...
import com.cloudera.director.spi.v1.provider.util.AbstractResourceProviderMetadataBuilder;
 ...
 */
public class SimpleDatabaseServerProviderMetadataBuilder extends AbstractResourceProviderMetadataBuilder<SimpleDatabaseServerProviderMetadataBuilder, SimpleDatabaseServerProviderMetadata> {
  ...
  protected SimpleDatabaseServerProviderMetadata build(String id, String name, String description,
    ...
    return new SimpleDatabaseServerProviderMetadata(id, name, description, providerClass,
        providerConfigurationProperties, resourceTemplateConfigurationProperties, supportedDatabaseTypes);
  }
}
