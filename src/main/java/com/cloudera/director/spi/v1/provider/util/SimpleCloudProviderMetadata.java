...
public class SimpleCloudProviderMetadata
   ...
   * @param configurationProperties     the list of configuration properties that can be given to configure the provider
  ...
  public SimpleCloudProviderMetadata(String id, String name, String description,
      List<ConfigurationProperty> configurationProperties, CredentialsProviderMetadata credentialsProviderMetadata,
