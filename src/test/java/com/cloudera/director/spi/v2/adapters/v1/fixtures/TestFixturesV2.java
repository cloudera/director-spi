...
import com.cloudera.director.spi.v2.adapters.v1.fixtures.TestCloudProviderV2.TestLauncher;
import com.cloudera.director.spi.v2.adapters.v1.fixtures.TestComputeProviderV2.TestComputeInstance;
import com.cloudera.director.spi.v2.adapters.v1.fixtures.TestComputeProviderV2.TestComputeInstanceTemplate;
import com.cloudera.director.spi.v2.adapters.v1.fixtures.TestComputeProviderV2.TestComputeProvider;
import com.cloudera.director.spi.v2.adapters.v1.fixtures.TestDatabaseProviderV2.TestDatabaseServerInstance;
import com.cloudera.director.spi.v2.adapters.v1.fixtures.TestDatabaseProviderV2.TestDatabaseServerInstanceTemplate;
import com.cloudera.director.spi.v2.adapters.v1.fixtures.TestDatabaseProviderV2.TestDatabaseServerProvider;
...
import com.cloudera.director.spi.v2.model.util.SimpleConfigurationPropertyValue;
...
import static com.cloudera.director.spi.v2.adapters.v1.fixtures.TestCloudProviderV2.CLOUD_PROVIDER_METADATA;

/**
 * Contains objects that implement SPI V2. The data in these objects should
 * be equivalent to the objects in {@link TestFixturesV1}.
 */
public class TestFixturesV2 {
